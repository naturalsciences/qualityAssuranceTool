...
```bash
docker run -v ./conf:/app/conf -v ./outputs:/app/outputs --network frost-docker_frosty_net qc_sensorthings "data_api.filter.phenomenonTime.range=[2023-01-04 12:00, 2025-01-01 10:00]"
```
=== Regions
